...
public sealed record FileTransferResult(int Succeeded, int Skipped, IReadOnlyList<FileTransferFailure> Failures, IReadOnlyList<string> SuccessfulSourcePaths);